# mirzabot-patches
ضمن تشکر از توسعه دهنده ربات میرزا mahdiMGF2/mirzabot که تغییرات بر روی اسکریپت ورژن 0.3.1 رایگان ایشان اعمال شده است. ورژن اصلی مورد نظر که حتماْ بایستی نصب باشد نگارش 0.3.1 است .
